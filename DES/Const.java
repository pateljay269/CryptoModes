...
public class Const {
    ...
    public static final int[] kShift = {
    ...
    public static int[] setBit4(int ascii) {
        int size = 4;
    ...
    public static int[] permutation(int[] ar, int table[]) {
        try {
            int arr[] = new int[table.length];
            for (int i = 0, j = 0; i < arr.length & j < table.length; i++, j++) {
                int pos = table[i] - 1;
                arr[i] = ar[pos];
            }
            return arr;
    ...
    public static int[][] leftShift(int arr[][], int round) {
        for (int i = 0; i < arr.length; i++) {
            for (int shift = 0; shift < round; shift++) {
                int n = arr[i].length;
                int temp = arr[i][0];
                System.arraycopy(arr[i], 1, arr[i], 0, n - 1);
                arr[i][n - 1] = temp;
            }
        }
        return arr;
    ...
    public static int[][] rightShift(int arr[][], int round) {
        for (int i = 0; i < arr.length; i++) {
            for (int shift = 0; shift < round; shift++) {
                int n = arr[i].length;
                int temp = arr[i][n - 1];
                System.arraycopy(arr[i], 0, arr[i], 1, n - 1);
                arr[i][0] = temp;
            }
        }
        return arr;
