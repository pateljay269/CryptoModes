...
public class CFM {
    ...
    private static void setData(String msg) {
        try {
            ...
            String cb1 = CFMode(msg, iv, key, true);
            String cb2 = CFMode(cb1, iv, key, false);

            System.out.println("CFM:\t" + cb1 + "\t->\t" + cb2);
    ...
    private static String CFMode(String msg, String IV, String ky, boolean EncDnc) {
        try {
